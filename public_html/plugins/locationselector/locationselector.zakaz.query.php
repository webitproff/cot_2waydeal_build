...
/**
 * [BEGIN_COT_EXT]
 * Hooks=zakaz.posts.query,zakaz.topics.query
 * Order=60
 * [END_COT_EXT]
 */
...
if (!empty($location['country'])) {
    $where['location'] = "ft_prj_country=" . cot::$db->quote($location['country']);
}
if ($location['region'] > 0) {
    $where['location'] =  "ft_prj_region=" . $location['region'];
}
if ($location['city'] > 0) {
    $where['location'] = "ft_prj_city=" . $location['city'];
}
