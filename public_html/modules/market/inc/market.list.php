<?php
/**
 * market module. filename market.list.php
 *
 * @package market
 * @version 3.0.0
...
if (!empty($c)) {
    cot::$out['subtitle'] = (!empty($cfg['market']['cat_' . $c]['market_cat_metatitle'])) ? $cfg['market']['cat_' . $c]['market_cat_metatitle'] : $cfg['market']['cat___default']['market_cat_metatitle'];
    cot::$out['subtitle'] = (!empty($out['subtitle'])) ? $out['subtitle'] : $L['market'];
    cot::$out['desc'] = (!empty($cfg['market']['cat_' . $c]['market_cat_metadesc'])) ? $cfg['market']['cat_' . $c]['market_cat_metadesc'] : $cfg['market']['cat___default']['market_cat_metadesc'];
    cot::$out['keywords'] = (!empty($cfg['market']['cat_' . $c]['market_cat_keywords'])) ? $cfg['market']['cat_' . $c]['market_cat_keywords'] : $cfg['market']['cat___default']['market_cat_keywords'];
} else {
    cot::$out['subtitle'] = (!empty($cfg['market']['cat___default']['market_cat_metatitle'])) ? $cfg['market']['cat___default']['market_cat_metatitle'] : $L['market'];
    cot::$out['desc'] = $cfg['market']['cat___default']['market_cat_metadesc'];
    cot::$out['keywords'] = $cfg['market']['cat___default']['market_cat_keywords'];
}
