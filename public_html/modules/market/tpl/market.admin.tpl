      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-5">
          <div class="row align-items-center">
			<div class="col-md-3 text-center text-md-start">
			  ...
			  <div class="att-image">{PRD_ROW_ID|att_display('market',$this,'','attacher.display.admin.list','images',1)}</div>
			  <!-- ELSE -->
        ...
        <div class="col-md-2">
          <div class="float-end d-flex flex-wrap gap-1">
			...
			<a href="{PRD_ROW_ADMIN_EDIT_URL}" class="button btn btn-sm btn-outline-warning"><i class="fa-solid fa-pen me-1"></i>{PHP.L.Edit}</a>
          </div>
        </div>
      </div>
    </div>
